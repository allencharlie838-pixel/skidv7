...
if not shared.VapeDeveloper then
	...
	local ok, res = pcall(function()
		return game:HttpGet('https://api.github.com/repos/' .. REPO .. '/commits/' .. BRANCH, true)
	end)
	...
	if commit ~= BRANCH and (isfile('newvape/profiles/commit.txt') and readfile('newvape/profiles/commit.txt') or '') ~= commit then
		wipeFolder('newvape')
